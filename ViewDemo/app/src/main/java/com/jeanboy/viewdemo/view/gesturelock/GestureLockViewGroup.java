package com.jeanboy.viewdemo.view.gesturelock;
...
public class GestureLockViewGroup extends RelativeLayout {
    private static final String TAG = GestureLockViewGroup.class.getSimpleName();
    ...
    private List<Integer> mChoose = new ArrayList<>();//保存用户选中的GestureLockView的id
